...
Cкачиваем, причесываем и анализируем годовую бухгалтерскую отчетность 
российских компаний.

**Исходные данные**: [Росстат][gks] (данные с 2012 года)
...
**Название пакета**: `boo` (сокращение от "бухгалтерская отчетность организаций")
...
занять длительное время. Для выхода из интерпретатора нажать \[Ctrl-Z\] + \[Enter\] .
