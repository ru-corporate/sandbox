...
Выполните задания на python (по согласованию - можно на R):

1. Скачать данный репозитарий. Загрузить и преобразовать данные за 2012 год 
   как показано в [example_start.py](example_start.py).
...
- Чего в принципе нет в данных бухгалтерской отчетности (занятость, амортизация)? 
  Какие подходы есть это оценить? 
- Какие компании "не в своей" отрасли?
- Заполняет ли кто-то раздел 6? Какие компании заполняют раздел 4?
- Определите пары переменных, которые связаны между собой. Покажите эту связь на   
  графиках. При каких условиях эта связь имеет место? Что влияет на значимость этой зависиомсти?
- Что в наборе данных поддается анализу с помощью регрессий или классификаций?
- Какие компании активно инвестируют? Как они финансиурют инвестиции? 
- У кого растут продажи? Есть ли закономерности?
